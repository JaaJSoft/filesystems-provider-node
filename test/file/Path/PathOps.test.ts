    ...
    async () => {
        if (os.platform() === "win32") {
            ...
            await (await (await (await (await (await (await (await (await (await (await (await (await (await (await PathOps.test("/a"))
                ...
                .relativizeFail("."))
                .relativizeFail("..");
            await (await (await (await (await (await (await (await (await (await (await (await (await (await (await PathOps.test("/a/b"))
                .relativize("/a/b", ""))
                .relativize("/a", ".."))
                .relativize("/", "../.."))
                .relativize("/.", "../.."))
                ...
                .relativizeFail("."))
                .relativizeFail("..");
            await (await (await (await (await (await (await (await (await (await (await (await (await (await (await (await (await (await (await (await PathOps.test("/a/b/c"))
                .relativize("/a/b/c", ""))
                .relativize("/a/b", ".."))
                .relativize("/a", "../.."))
                .relativize("/", "../../.."))
                ...
                .relativizeFail("."))
                .relativizeFail("..");
            await (await (await (await (await (await (await (await (await (await (await (await (await (await (await (await (await (await PathOps.test("/../a/b"))
                .relativize("/a/b", ""))
                .relativize("/a", ".."))
                .relativize("/", "../.."))
                .relativize("/.", "../.."))
            ...
            await (await (await (await (await (await (await (await (await (await (await (await (await PathOps.test("/a/.."))
                ...
                .relativizeFail("."))
                .relativizeFail("..");
            await (await (await (await (await (await (await (await (await (await (await (await (await PathOps.test("/"))
                .relativize("/a", "a"))
                .relativize("/", ""))          // "." is also valid
                .relativize("/.", ""))
                .relativize("/..", ""))
            ...
            await (await (await (await (await (await (await (await (await (await (await (await PathOps.test("a/b"))
                ...
                .relativizeFail("/"))
                .relativizeFail("/x");
            await (await (await (await (await (await (await (await (await (await (await (await (await (await (await PathOps.test("a/b/c"))
                .relativize("a/b/c", ""))
                .relativize("a/b", ".."))
                .relativize("a", "../.."))
                .relativize("", "../../.."))
            ...
            // .relativizeFail("."))
            // .relativizeFail("x");
            (await (await (await (await (await (await (await PathOps.test("../a"))
                .relativize("../a/b", "b"))
                .relativize("../a", ""))
                .relativize("..", ".."))
                .relativize("./..", ".."))
